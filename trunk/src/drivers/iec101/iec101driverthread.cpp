...
int Iec101DriverThread::pipe_put(char *buf, int len, char* pipe_name)
{ 
	int rc = 0;
...
void Iec101DriverThread::TerminateIEC() // parent requests the thread close
{
	IT_IT("Iec101DriverThread::TerminateIEC");
