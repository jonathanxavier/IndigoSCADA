...
File: Opc_client_comConfigurationData.cpp
...
Opc_client_comConfigurationData::Opc_client_comConfigurationData(QWidget *parent, const char *name)
...
Opc_client_comConfigurationData::~Opc_client_comConfigurationData()
{
}
