...
File: Opc_client_comConfiguration.cpp
Last generated: Mon May 22 17:14:04 2000
*********************************************************************/
#include "Opc_client_comConfiguration.h"
#include <qt.h>
#include "opc_client_com.h"
#define Inherited Opc_client_comConfigurationData
Opc_client_comConfiguration::Opc_client_comConfiguration
(
QWidget* parent,
const char* name,
const char *receipe
...
{
	setCaption(tr("Opc_client_com Configuration"));
...
void Opc_client_comConfiguration::Help()
{
	//
	// invoke the help viewer for the Opc_client_com
	// 
	QSHelp("Opc_client_com");
}
void Opc_client_comConfiguration::OkClicked()
{
	//
	...
	Opc_client_com::pDriver->CreateNewUnit(this,Name->text(), (NItems->text()).toInt() );  

	accept();
		
}
void Opc_client_comConfiguration::QueryResponse (QObject *p, const QString &c, int id, QObject*caller) // handles database responses
{
	if(p != this) return;
	switch(id)
	{
