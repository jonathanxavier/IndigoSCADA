...
# ADD LINK32 scadad.lib utilitiesd.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib uuid.lib WSOCK32.LIB qt-mt$(QTVER).lib fifo.lib eic.lib /nologo /dll /incremental:no /pdb:"Debug/Calculated.pdb" /debug /machine:I386 /pdbtype:sept /libpath:"$(QTDIR)\lib" /libpath:"c:\scada\lib" /libpath:"..\..\softlogic\EiC-4.4.2\src"
