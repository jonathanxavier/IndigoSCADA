...
int Iec103DriverThread::pipe_put(char *buf, int len, char* pipe_name)
{ 
	int rc = 0;
...
void Iec103DriverThread::TerminateIEC() // parent requests the thread close
{
	IT_IT("Iec103DriverThread::TerminateIEC");
