...
#ifndef MODBUS_MASTER__INSTANCE
#define MODBUS_MASTER__INSTANCE
...
class MODBUS_MASTERDRV modbus_master_Instance : public DriverInstance 
{
	Q_OBJECT
	//
	//
...
//	modbus_master_DriverThread *pConnect;
	...
	{
		IT_IT("modbus_master_Instance::modbus_master_Instance");
