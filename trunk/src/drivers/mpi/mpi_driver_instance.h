...
#ifndef MPI_DRIVER__INSTANCE
#define MPI_DRIVER__INSTANCE
...
class MPI_DRIVERDRV Mpi_driver_Instance : public DriverInstance 
{
	Q_OBJECT
	//
	//
...
//	QStringList SampleList; // list of sample points
    ...
    pConnect(NULL)
	{
		IT_IT("Mpi_driver_Instance::Mpi_driver_Instance");
        ...
        strcat(fifo_ctr_name, "mpi");
        strcat(fifo_mon_name, "mpi");
