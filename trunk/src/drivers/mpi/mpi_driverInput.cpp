...
#define Inherited Mpi_driverInputData

Mpi_driverInput::Mpi_driverInput
(
QWidget* parent,
const char* name
)
...
void Mpi_driverInput::Load(const QString &s)// load the configuration
{
	IT_IT("Mpi_driverInput::Load");
...
void Mpi_driverInput::Save(const QString &s)// save the configuration
{
	//
