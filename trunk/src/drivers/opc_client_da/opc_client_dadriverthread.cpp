...
DWORD Opc_client_da_DriverThread::g_dwReadTransID = 1;
DWORD Opc_client_da_DriverThread::g_dwWriteTransID = 2;
//FILE *Opc_client_da_DriverThread::g_stream = NULL; // file log handle
IOPCServer *Opc_client_da_DriverThread::g_pIOPCServer = NULL;

DriverInstance *Opc_client_da_DriverThread::StaticParent = NULL;
DriverThread *Opc_client_da_DriverThread::StaticThis = NULL;
...
{
	IT_IT("Opc_client_da_DriverThread::SendEvent");
...
void Opc_client_da_DriverThread::post_val(SpValue &v, QString &name)
{
...
void Opc_client_da_DriverThread::SendEvent2(VARIANT *pValue, const FILETIME* ft, DWORD pwQualities, OPCHANDLE phClientItem)
{
	IT_IT("Opc_client_da_DriverThread::SendEvent2");
...
signed __int64 Opc_client_da_DriverThread::Epoch_from_FILETIME(const FILETIME *fileTime)
{
