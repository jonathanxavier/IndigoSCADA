...
# ADD LINK32 advapi32.lib user32.lib snmpapi.lib utilitiesd.lib wsock32.lib qt-mtnc$(QTVER).lib qtmain.lib /nologo /subsystem:windows /incremental:no /pdb:"Debug/manager.pdb" /debug /machine:I386 /pdbtype:sept /libpath:"$(QTDIR)\lib" /libpath:"c:\scada\lib"
# SUBTRACT LINK32 /pdb:none
