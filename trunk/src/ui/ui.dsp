...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib uuid.lib WSOCK32.LIB snmpapi.lib scadad.lib utilitiesd.lib qt-mtnc$(QTVER).lib qtmain.lib /nologo /subsystem:windows /incremental:no /pdb:"Debug/ist.pdb" /debug /machine:I386 /nodefaultlib:"LIBCMTD LIBCMT" /out:"c:\scada\bin/ist.exe" /pdbtype:sept /libpath:"$(QTDIR)\lib" /libpath:"c:\scada\lib"
