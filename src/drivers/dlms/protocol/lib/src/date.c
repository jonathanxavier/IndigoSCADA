    ...
    uint32_t value)
{
    ...
    a = (uint32_t)((4 * value + 102032) / 146097 + 15);
    b = (uint32_t)(value + 2442113 + a - (a / 4));
    c = (20 * b - 2442) / 7305;
    d = b - 365 * c - (c / 4);
    e = d * 1000 / 30601;
    //January and February are counted as months 13 and 14 of the previous year
    ...
    unsigned char* dayOfWeek)
{
    ...
    epoch /= 24;
    //Convert Unix time to date
    a = (uint32_t)((4 * epoch + 102032) / 146097 + 15);
    b = (uint32_t)(epoch + 2442113 + a - (a / 4));
    c = (20 * b - 2442) / 7305;
    d = b - 365 * c - (c / 4);
    e = d * 1000 / 30601;
    f = d - e * 30 - e * 601 / 1000;
