...
int Dnp3DriverThread::pipe_put(char *buf, int len, char* pipe_name)
{ 
	int rc = 0;
...
void Dnp3DriverThread::TerminateIEC() // parent requests the thread close
{
	IT_IT("Dnp3DriverThread::TerminateIEC");
