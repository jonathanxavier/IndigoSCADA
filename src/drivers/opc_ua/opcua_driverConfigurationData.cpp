    ...
    : QDialog( parent, name, modal, fl )
{
    ...
    OPCUAServerIPPortText = new QLineEdit( this, "OPCUAServerIPPortText" );
    OPCUAServerIPPortText->setGeometry( QRect( 170, 170, 200, 20 ) );
...
void Opcua_driverConfigurationData::languageChange()
{
    ...
    buttonGroup1->setTitle( tr( "OPCUA Context" ) );
...
void Opcua_driverConfigurationData::RTUContextActive(bool)
{
    qWarning( "Opcua_driverConfigurationData::RTUContextActive(bool): Not implemented yet" );
}

void Opcua_driverConfigurationData::TCPContextActive(bool)
{
    qWarning( "Opcua_driverConfigurationData::TCPContextActive(bool): Not implemented yet" );
}
