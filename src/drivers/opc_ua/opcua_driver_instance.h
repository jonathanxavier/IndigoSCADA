...
#ifndef OPCUA_DRIVER__INSTANCE
#define OPCUA_DRIVER__INSTANCE
...
class Opcua_DriverThread;

class OPCUA_DRIVERDRV Opcua_driver_Instance : public DriverInstance 
{
	Q_OBJECT
	//
	//
...
//	QStringList SampleList; // list of sample points
	...
	{
		IT_IT("Opcua_driver_Instance::Opcua_driver_Instance");
