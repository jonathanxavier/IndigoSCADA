...
File: modbus_masterInputData.cpp
...
modbus_masterInputData::modbus_masterInputData(QWidget *parent, const char *name)
...
modbus_masterInputData::~modbus_masterInputData()
{
}
