...
File: modbus_masterConfigurationData.cpp
...
modbus_masterConfigurationData::modbus_masterConfigurationData(QWidget *parent, const char *name)
: QDialog(parent, name, TRUE, 208)
{
	...
	MODBUServerIPAddressText = new QLineEdit(this, "LineEdit_7");
	MODBUServerIPAddressText->setGeometry(200, 80, 100, 30);
	MODBUServerIPAddressText->setMinimumSize(0, 0);
	MODBUServerIPAddressText->setMaximumSize(32767, 32767);
	MODBUServerIPAddressText->setFocusPolicy(QWidget::StrongFocus);
	MODBUServerIPAddressText->setBackgroundMode(QWidget::PaletteBase);
#if QT_VERSION < 300
	MODBUServerIPAddressText->setFontPropagation(QWidget::SameFont);
	MODBUServerIPAddressText->setPalettePropagation(QWidget::SameFont);
	#endif
	MODBUServerIPAddressText->setText( tr( "" ) );
	MODBUServerIPAddressText->setMaxLength( 100 );
	MODBUServerIPAddressText->setFrame( QLineEdit::Normal );
	MODBUServerIPAddressText->setFrame( TRUE );
	MODBUServerIPAddressText->setAlignment( AlignLeft );
...
modbus_masterConfigurationData::~modbus_masterConfigurationData()
{
}
