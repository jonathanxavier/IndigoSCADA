...
File: modbus_masterCommandData.cpp
...
modbus_masterCommandData::modbus_masterCommandData(QWidget *parent, const char *name)
...
modbus_masterCommandData::~modbus_masterCommandData()
{
}
