...
#define TIME_OUT_USEC_BEGIN_OF_TRAME 500000
#define TIME_OUT_SEC_BEGIN_OF_TRAME 0
#define TIME_OUT_USEC_END_OF_TRAME   500000
#define TIME_OUT_SEC_END_OF_TRAME   0
