...
struct modbusItem
{
	...
	int modbus_bit_size; //size in bit of the the memory to fetch
	int offset_in_bits; //offset in bits into the memory to fetch (to sum with start address in order to find the address of interested data)
	//////////////control center part///////////////////////////////////
