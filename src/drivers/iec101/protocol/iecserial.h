...
#define IEC101_BUF_LEN		255
#define IEC101_ASDU_MAX		249 //IEC101_BUF_LEN - (4 octetcs for header(0x68 + length+ length + 0x68) + 1 octect for checksum + 1 octect for end character (0x16))
