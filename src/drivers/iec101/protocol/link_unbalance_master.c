	...
	{   
		...
		if(!frame_error)
		{
			...
			{   
				...
				ACD=1; //Force request of class 1 data
...
{   
	...
	{   
		switch(link_state)
		{   
			case 1: STAM_LINKRESET_moveto(); break;   
			case 2: STAM_WAITFORREQ_moveto(); break;   
			case 3: STAM_EXREQLINK_moveto(); break;   
			case 4: STAM_EXRESETLINK_moveto(); break;   
			case 5: STAM_SLAVELINKAVAIL_moveto(); break;   
			case 6: STAM_EXREQRES_moveto(); break;   
			case 7: STAM_SENDCON_moveto(); break;   
			default:;   
		}
...
void set_link_state(int state)
{
	switch(state)
	{
		case STAM_SLAVELINKAVAIL: state_iec_101_link = LNK_CONNECTED; break;
		case STAM_WAITFORREQ: state_iec_101_link = LNK_IDLE; reset_state_machines(); break;
		default: break;
	}
}
