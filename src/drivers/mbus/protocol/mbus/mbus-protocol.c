...
mbus_error_str_set(char *message)
{
    if (message)
    {
        my_snprintf(error_str, sizeof(error_str), "%s", message);
    }
}
...
mbus_error_reset()
{
    my_snprintf(error_str, sizeof(error_str), "no errors");
}
...
mbus_frame_verify(mbus_frame *frame)
{
    ...
    if (frame)
    {
        switch (frame->type)
        {
            ...
            case MBUS_FRAME_TYPE_SHORT:
                ...
                {
                    my_snprintf(error_str, sizeof(error_str), "No frame start");
                ...
                {
                    my_snprintf(error_str, sizeof(error_str), "Unknown Control Code 0x%.2x", frame->control);
            ...
            case MBUS_FRAME_TYPE_LONG:
                ...
                {
                    my_snprintf(error_str, sizeof(error_str), "Frame length 1 != 2");
                ...
                {
                    my_snprintf(error_str, sizeof(error_str), "Frame length 1 != calc length");
            ...
            default:
                my_snprintf(error_str, sizeof(error_str), "Unknown frame type 0x%.2x", frame->type);
        ...
        {
            my_snprintf(error_str, sizeof(error_str), "No frame stop");
        ...
        {
            my_snprintf(error_str, sizeof(error_str), "Invalid checksum (0x%.2x != 0x%.2x)", frame->checksum, checksum);
    ...
    my_snprintf(error_str, sizeof(error_str), "Got null pointer to frame.");
...
int
mbus_data_long_long_decode(unsigned char *int_data, size_t int_data_size, int64_t *value)
{
    size_t i;
    int neg;
    *value = 0;
...
mbus_data_bin_decode(unsigned char *dst, const unsigned char *src, size_t len, size_t max_len)
{
    ...
    if (src && dst)
    {
        while((i < len) && ((pos+3) < max_len)) {
            pos += my_snprintf(&dst[pos], max_len - pos, "%.2X ", src[i]);
            i++;
        }
...
mbus_data_fixed_medium(mbus_data_fixed *data)
{
    ...
    if (data)
    {
        ...
        {
            case 0x00:
                my_snprintf(buff, sizeof(buff), "Other");
                break;
            case 0x01:
                my_snprintf(buff, sizeof(buff), "Oil");
                break;
            case 0x02:
                my_snprintf(buff, sizeof(buff), "Electricity");
                break;
            case 0x03:
                my_snprintf(buff, sizeof(buff), "Gas");
                break;
            case 0x04:
                my_snprintf(buff, sizeof(buff), "Heat");
                break;
            case 0x05:
                my_snprintf(buff, sizeof(buff), "Steam");
                break;
            case 0x06:
                my_snprintf(buff, sizeof(buff), "Hot Water");
                break;
            case 0x07:
                my_snprintf(buff, sizeof(buff), "Water");
                break;
            case 0x08:
                my_snprintf(buff, sizeof(buff), "H.C.A.");
                break;
            case 0x09:
                my_snprintf(buff, sizeof(buff), "Reserved");
                break;
            case 0x0A:
                my_snprintf(buff, sizeof(buff), "Gas Mode 2");
                break;
            case 0x0B:
                my_snprintf(buff, sizeof(buff), "Heat Mode 2");
                break;
            case 0x0C:
                my_snprintf(buff, sizeof(buff), "Hot Water Mode 2");
                break;
            case 0x0D:
                my_snprintf(buff, sizeof(buff), "Water Mode 2");
                break;
            case 0x0E:
                my_snprintf(buff, sizeof(buff), "H.C.A. Mode 2");
                break;
            case 0x0F:
                my_snprintf(buff, sizeof(buff), "Reserved");
                break;
            default:
                my_snprintf(buff, sizeof(buff), "unknown");
                break;
        }
...
mbus_data_fixed_unit(int medium_unit_byte)
{
    ...
    {
        case 0x00:
            my_snprintf(buff, sizeof(buff), "h,m,s");
            break;
        case 0x01:
            my_snprintf(buff, sizeof(buff), "D,M,Y");
            break;

        case 0x02:
            my_snprintf(buff, sizeof(buff), "Wh");
            break;
        case 0x03:
            my_snprintf(buff, sizeof(buff), "10 Wh");
            break;
        case 0x04:
            my_snprintf(buff, sizeof(buff), "100 Wh");
            break;
        case 0x05:
            my_snprintf(buff, sizeof(buff), "kWh");
            break;
        case 0x06:
            my_snprintf(buff, sizeof(buff), "10 kWh");
            break;
        case 0x07:
            my_snprintf(buff, sizeof(buff), "100 kWh");
            break;
        case 0x08:
            my_snprintf(buff, sizeof(buff), "MWh");
            break;
        case 0x09:
            my_snprintf(buff, sizeof(buff), "10 MWh");
            break;
        case 0x0A:
            my_snprintf(buff, sizeof(buff), "100 MWh");
            break;

        case 0x0B:
            my_snprintf(buff, sizeof(buff), "kJ");
            break;
        case 0x0C:
            my_snprintf(buff, sizeof(buff), "10 kJ");
            break;
        case 0x0E:
            my_snprintf(buff, sizeof(buff), "100 kJ");
            break;
        case 0x0D:
            my_snprintf(buff, sizeof(buff), "MJ");
            break;
        case 0x0F:
            my_snprintf(buff, sizeof(buff), "10 MJ");
            break;
        case 0x10:
            my_snprintf(buff, sizeof(buff), "100 MJ");
            break;
        case 0x11:
            my_snprintf(buff, sizeof(buff), "GJ");
            break;
        case 0x12:
            my_snprintf(buff, sizeof(buff), "10 GJ");
            break;
        case 0x13:
            my_snprintf(buff, sizeof(buff), "100 GJ");
            break;

        case 0x14:
            my_snprintf(buff, sizeof(buff), "W");
            break;
        case 0x15:
            my_snprintf(buff, sizeof(buff), "10 W");
            break;
        case 0x16:
            my_snprintf(buff, sizeof(buff), "100 W");
            break;
        case 0x17:
            my_snprintf(buff, sizeof(buff), "kW");
            break;
        case 0x18:
            my_snprintf(buff, sizeof(buff), "10 kW");
            break;
        case 0x19:
            my_snprintf(buff, sizeof(buff), "100 kW");
            break;
        case 0x1A:
            my_snprintf(buff, sizeof(buff), "MW");
            break;
        case 0x1B:
            my_snprintf(buff, sizeof(buff), "10 MW");
            break;
        case 0x1C:
            my_snprintf(buff, sizeof(buff), "100 MW");
            break;

        case 0x1D:
            my_snprintf(buff, sizeof(buff), "kJ/h");
            break;
        case 0x1E:
            my_snprintf(buff, sizeof(buff), "10 kJ/h");
            break;
        case 0x1F:
            my_snprintf(buff, sizeof(buff), "100 kJ/h");
            break;
        case 0x20:
            my_snprintf(buff, sizeof(buff), "MJ/h");
            break;
        case 0x21:
            my_snprintf(buff, sizeof(buff), "10 MJ/h");
            break;
        case 0x22:
            my_snprintf(buff, sizeof(buff), "100 MJ/h");
            break;
        case 0x23:
            my_snprintf(buff, sizeof(buff), "GJ/h");
            break;
        case 0x24:
            my_snprintf(buff, sizeof(buff), "10 GJ/h");
            break;
        case 0x25:
            my_snprintf(buff, sizeof(buff), "100 GJ/h");
            break;

        case 0x26:
            my_snprintf(buff, sizeof(buff), "ml");
            break;
        case 0x27:
            my_snprintf(buff, sizeof(buff), "10 ml");
            break;
        case 0x28:
            my_snprintf(buff, sizeof(buff), "100 ml");
            break;
        case 0x29:
            my_snprintf(buff, sizeof(buff), "l");
            break;
        case 0x2A:
            my_snprintf(buff, sizeof(buff), "10 l");
            break;
        case 0x2B:
            my_snprintf(buff, sizeof(buff), "100 l");
            break;
        case 0x2C:
            my_snprintf(buff, sizeof(buff), "m^3");
            break;
        case 0x2D:
            my_snprintf(buff, sizeof(buff), "10 m^3");
            break;
        case 0x2E:
            my_snprintf(buff, sizeof(buff), "100 m^3");
            break;

        case 0x2F:
            my_snprintf(buff, sizeof(buff), "ml/h");
            break;
        case 0x30:
            my_snprintf(buff, sizeof(buff), "10 ml/h");
            break;
        case 0x31:
            my_snprintf(buff, sizeof(buff), "100 ml/h");
            break;
        case 0x32:
            my_snprintf(buff, sizeof(buff), "l/h");
            break;
        case 0x33:
            my_snprintf(buff, sizeof(buff), "10 l/h");
            break;
        case 0x34:
            my_snprintf(buff, sizeof(buff), "100 l/h");
            break;
        case 0x35:
            my_snprintf(buff, sizeof(buff), "m^3/h");
            break;
        case 0x36:
            my_snprintf(buff, sizeof(buff), "10 m^3/h");
            break;
        case 0x37:
            my_snprintf(buff, sizeof(buff), "100 m^3/h");
            break;

        case 0x38:
            my_snprintf(buff, sizeof(buff), "1e-3 °C");
            break;
        case 0x39:
            my_snprintf(buff, sizeof(buff), "units for HCA");
            break;
        case 0x3A:
        case 0x3B:
        case 0x3C:
        case 0x3D:
            ...
            break;
        case 0x3E:
            my_snprintf(buff, sizeof(buff), "reserved but historic");
            break;
        case 0x3F:
            my_snprintf(buff, sizeof(buff), "without units");
            break;
        default:
            my_snprintf(buff, sizeof(buff), "unknown");
            break;
...
mbus_data_variable_medium_lookup(unsigned char medium)
{
    ...
    switch (medium)
    {
        ...
        case MBUS_VARIABLE_DATA_MEDIUM_HEAT_OUT:
            my_snprintf(buff, sizeof(buff), "Heat: Outlet");
            break;
        ...
        case MBUS_VARIABLE_DATA_MEDIUM_HOT_WATER:
            my_snprintf(buff, sizeof(buff), "Warm water (30-90°C)");
            break;
        ...
        case MBUS_VARIABLE_DATA_MEDIUM_HEAT_COST:
            my_snprintf(buff, sizeof(buff), "Heat Cost Allocator");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_COMPR_AIR:
            my_snprintf(buff, sizeof(buff), "Compressed Air");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_COOL_OUT:
            my_snprintf(buff, sizeof(buff), "Cooling load meter: Outlet");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_COOL_IN:
            my_snprintf(buff, sizeof(buff), "Cooling load meter: Inlet");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_HEAT_IN:
            my_snprintf(buff, sizeof(buff), "Heat: Inlet");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_HEAT_COOL:
            my_snprintf(buff, sizeof(buff), "Heat / Cooling load meter");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_BUS:
            my_snprintf(buff, sizeof(buff), "Bus/System");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_UNKNOWN:
            my_snprintf(buff, sizeof(buff), "Unknown Medium");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_IRRIGATION:
            my_snprintf(buff, sizeof(buff), "Irrigation Water");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_WATER_LOGGER:
            my_snprintf(buff, sizeof(buff), "Water Logger");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_GAS_LOGGER:
            my_snprintf(buff, sizeof(buff), "Gas Logger");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_GAS_CONV:
            my_snprintf(buff, sizeof(buff), "Gas Converter");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_COLORIFIC:
            my_snprintf(buff, sizeof(buff), "Calorific value");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_BOIL_WATER:
            my_snprintf(buff, sizeof(buff), "Hot water (>90°C)");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_COLD_WATER:
            my_snprintf(buff, sizeof(buff), "Cold water");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_DUAL_WATER:
            my_snprintf(buff, sizeof(buff), "Dual water");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_PRESSURE:
            my_snprintf(buff, sizeof(buff), "Pressure");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_ADC:
            my_snprintf(buff, sizeof(buff), "A/D Converter");
            break;

        case MBUS_VARIABLE_DATA_MEDIUM_SMOKE:
          my_snprintf(buff, sizeof(buff), "Smoke Detector");
          break;

        case MBUS_VARIABLE_DATA_MEDIUM_ROOM_SENSOR:
          my_snprintf(buff, sizeof(buff), "Ambient Sensor");
          break;

        case MBUS_VARIABLE_DATA_MEDIUM_GAS_DETECTOR:
          my_snprintf(buff, sizeof(buff), "Gas Detector");
          break;

        case MBUS_VARIABLE_DATA_MEDIUM_BREAKER_E:
          my_snprintf(buff, sizeof(buff), "Breaker: Electricity");
          break;

        case MBUS_VARIABLE_DATA_MEDIUM_VALVE:
          my_snprintf(buff, sizeof(buff), "Valve: Gas or Water");
          break;

        case MBUS_VARIABLE_DATA_MEDIUM_CUSTOMER_UNIT:
          my_snprintf(buff, sizeof(buff), "Customer Unit: Display Device");
          break;

        case MBUS_VARIABLE_DATA_MEDIUM_WASTE_WATER:
          my_snprintf(buff, sizeof(buff), "Waste Water");
          break;

        case MBUS_VARIABLE_DATA_MEDIUM_GARBAGE:
          my_snprintf(buff, sizeof(buff), "Garbage");
          break;

        case MBUS_VARIABLE_DATA_MEDIUM_SERVICE_UNIT:
          my_snprintf(buff, sizeof(buff), "Service Unit");
          break;

        case MBUS_VARIABLE_DATA_MEDIUM_RC_SYSTEM:
          my_snprintf(buff, sizeof(buff), "Radio Converter: System");
          break;

        case MBUS_VARIABLE_DATA_MEDIUM_RC_METER:
          my_snprintf(buff, sizeof(buff), "Radio Converter: Meter");
          break;
        ...
        // add more ...
        default:
            my_snprintf(buff, sizeof(buff), "Unknown medium (0x%.2x)", medium);
            break;
    }
...
mbus_unit_prefix(int exp)
{
    ...
    switch (exp)
    {
        ...
        case -3:
            my_snprintf(buff, sizeof(buff), "m");
            break;

        case -6:
            my_snprintf(buff, sizeof(buff), "my");
            break;

        case 1:
            my_snprintf(buff, sizeof(buff), "10 ");
            break;

        case 2:
            my_snprintf(buff, sizeof(buff), "100 ");
            break;

        case 3:
            my_snprintf(buff, sizeof(buff), "k");
            break;

        case 4:
            my_snprintf(buff, sizeof(buff), "10 k");
            break;

        case 5:
            my_snprintf(buff, sizeof(buff), "100 k");
            break;
        ...
        case 9:
            my_snprintf(buff, sizeof(buff), "G");
            break;

        default:
            my_snprintf(buff, sizeof(buff), "1e%d ", exp);
    }
...
mbus_vif_unit_lookup(unsigned char vif)
{
    ...
    switch (vif & MBUS_DIB_VIF_WITHOUT_EXTENSION) // ignore the extension bit in this selection
    {
        ...
        case 0x00+7:
            n = (vif & 0x07) - 3;
            my_snprintf(buff, sizeof(buff), "Energy (%sWh)", mbus_unit_prefix(n));
            break;
        ...
        case 0x08+7:
            ...
            n = (vif & 0x07);
            my_snprintf(buff, sizeof(buff), "Energy (%sJ)", mbus_unit_prefix(n));
        ...
        case 0x18+7:
            ...
            n = (vif & 0x07);
            my_snprintf(buff, sizeof(buff), "Mass (%skg)", mbus_unit_prefix(n-3));
        ...
        case 0x28+7:
            ...
            n = (vif & 0x07);
            my_snprintf(buff, sizeof(buff), "Power (%sW)", mbus_unit_prefix(n-3));
            //my_snprintf(buff, sizeof(buff), "Power (10^%d W)", n-3);
        ...
        case 0x30+7:
            ...
            n = (vif & 0x07);
            my_snprintf(buff, sizeof(buff), "Power (%sJ/h)", mbus_unit_prefix(n));
        ...
        case 0x10+7:
            ...
            n = (vif & 0x07);
            my_snprintf(buff, sizeof(buff), "Volume (%s m^3)", mbus_unit_prefix(n-6));
        ...
        case 0x38+7:
            ...
            n = (vif & 0x07);
            my_snprintf(buff, sizeof(buff), "Volume flow (%s m^3/h)", mbus_unit_prefix(n-6));
        ...
        case 0x40+7:
            ...
            n = (vif & 0x07);
            my_snprintf(buff, sizeof(buff), "Volume flow (%s m^3/min)", mbus_unit_prefix(n-7));
        ...
        case 0x48+7:
            ...
            n = (vif & 0x07);
            my_snprintf(buff, sizeof(buff), "Volume flow (%s m^3/s)", mbus_unit_prefix(n-9));
        ...
        case 0x50+7:
            ...
            n = (vif & 0x07);
            my_snprintf(buff, sizeof(buff), "Mass flow (%s kg/h)", mbus_unit_prefix(n-3));
        ...
        case 0x58+3:
            ...
            n = (vif & 0x03);
            my_snprintf(buff, sizeof(buff), "Flow temperature (%sdeg C)", mbus_unit_prefix(n-3));
        ...
        case 0x5C+3:
            ...
            n = (vif & 0x03);
            my_snprintf(buff, sizeof(buff), "Return temperature (%sdeg C)", mbus_unit_prefix(n-3));
        ...
        case 0x68+3:
            ...
            n = (vif & 0x03);
            my_snprintf(buff, sizeof(buff), "Pressure (%s bar)", mbus_unit_prefix(n-3));
        ...
        case 0x74+3:
            {
                ...
                if      ((vif & 0x7C) == 0x20)
                    offset = my_snprintf(buff, sizeof(buff), "On time ");
                else if ((vif & 0x7C) == 0x24)
                    offset = my_snprintf(buff, sizeof(buff), "Operating time ");
                else if ((vif & 0x7C) == 0x70)
                    offset = my_snprintf(buff, sizeof(buff), "Averaging Duration ");
                else
                    offset = my_snprintf(buff, sizeof(buff), "Actuality Duration ");

                switch (vif & 0x03)
                {
                    case 0x00:
                        my_snprintf(&buff[offset], sizeof(buff)-offset, "(seconds)");
                        break;
                    case 0x01:
                        my_snprintf(&buff[offset], sizeof(buff)-offset, "(minutes)");
                        break;
                    case 0x02:
                        my_snprintf(&buff[offset], sizeof(buff)-offset, "(hours)");
                        break;
                    case 0x03:
                        my_snprintf(&buff[offset], sizeof(buff)-offset, "(days)");
                        break;
                }
            }
            break;
        ...
        case 0x6C+1:
            ...
            if (vif & 0x1)
                my_snprintf(buff, sizeof(buff), "Time Point (time & date)");
            else
                my_snprintf(buff, sizeof(buff), "Time Point (date)");
        ...
        case 0x60+3:
            ...
            my_snprintf(buff, sizeof(buff), "Temperature Difference (%s deg C)", mbus_unit_prefix(n-3));
        ...
        case 0x64+3:
            ...
            n = (vif & 0x03);
            my_snprintf(buff, sizeof(buff), "External temperature (%s deg C)", mbus_unit_prefix(n-3));

            break;

        // E110 1110 Units for H.C.A. dimensionless
        case 0x6E:
            my_snprintf(buff, sizeof(buff), "Units for H.C.A.");
            break;
        ...
        case 0x7C:
            my_snprintf(buff, sizeof(buff), "Custom VIF");
            break;

        // Fabrication No
        case 0x78:
            my_snprintf(buff, sizeof(buff), "Fabrication number");
            break;

        // Bus Address
        case 0x7A:
            my_snprintf(buff, sizeof(buff), "Bus Address");
            break;

        // Manufacturer specific: 7Fh / FF
        case 0x7F:
        case 0xFF:
            my_snprintf(buff, sizeof(buff), "Manufacturer specific");
            break;

        default:
            my_snprintf(buff, sizeof(buff), "Unknown (VIF=0x%.2X)", vif);
            break;
    }
...
mbus_data_error_lookup(int error)
{
    ...
    switch (error)
    {
        case MBUS_ERROR_DATA_UNSPECIFIED:
            my_snprintf(buff, sizeof(buff), "Unspecified error");
            break;

        case MBUS_ERROR_DATA_UNIMPLEMENTED_CI:
            my_snprintf(buff, sizeof(buff), "Unimplemented CI-Field");
            break;

        case MBUS_ERROR_DATA_BUFFER_TOO_LONG:
            my_snprintf(buff, sizeof(buff), "Buffer too long, truncated");
            break;

        case MBUS_ERROR_DATA_TOO_MANY_RECORDS:
            my_snprintf(buff, sizeof(buff), "Too many records");
            break;

        case MBUS_ERROR_DATA_PREMATURE_END:
            my_snprintf(buff, sizeof(buff), "Premature end of record");
            break;

        case MBUS_ERROR_DATA_TOO_MANY_DIFES:
            my_snprintf(buff, sizeof(buff), "More than 10 DIFE´s");
            break;

        case MBUS_ERROR_DATA_TOO_MANY_VIFES:
            my_snprintf(buff, sizeof(buff), "More than 10 VIFE´s");
            break;
        ...
        case MBUS_ERROR_DATA_APPLICATION_BUSY:
            my_snprintf(buff, sizeof(buff), "Application busy");
            break;

        case MBUS_ERROR_DATA_TOO_MANY_READOUTS:
            my_snprintf(buff, sizeof(buff), "Too many readouts");
            break;

        default:
            my_snprintf(buff, sizeof(buff), "Unknown error (0x%.2X)", error);
            break;
    }
...
mbus_vib_unit_lookup_fb(mbus_value_information_block *vib)
{
    ...
    switch (vib->vife[0] & MBUS_DIB_VIF_WITHOUT_EXTENSION)
    {
        ...
        case 0x0 + 1:
            ...
            if (n == 0)
                prefix = "0.1 ";
        my_snprintf(buff, sizeof(buff), "Energy (%sMWh)", prefix);
        break;
    case 0x2:
    case 0x2 + 1:
        // E000 001n
    ...
    case 0x4 + 3:
        // E000 01nn
        my_snprintf(buff, sizeof(buff), "Reserved (0x%.2x)", vib->vife[0]);
        break;
    case 0x8:
    case 0x8 + 1:
        // E000 100n
        ...
        if (n == 0)
           prefix = "0.1 ";
        my_snprintf(buff, sizeof(buff), "Energy (%sGJ)", prefix);
        break;
    case 0xA:
    case 0xA + 1:
    case 0xC:
    ...
    case 0x10 + 1:
        // E001 000n
        n = 0x01 & vib->vife[0];
        my_snprintf(buff, sizeof(buff), "Volume (%sm3)", mbus_unit_prefix(n+2));
        break;
    case 0x12:
    case 0x12 + 1:
    case 0x14:
    ...
    case 0x18 + 1:
        // E001 100n
        n = 0x01 & vib->vife[0];
        my_snprintf(buff, sizeof(buff), "Mass (%st)", mbus_unit_prefix(n+2));
        break;
    case 0x1A:
    case 0x1B:
    case 0x1C:
    ...
    case 0x21:
        // E010 0001
        my_snprintf(buff, sizeof(buff), "Volume (0.1 feet^3)");
        break;
    case 0x22:
    case 0x23:
        // E010 0010
        ...
        if (n == 0)
           prefix = "0.1 ";
        my_snprintf(buff, sizeof(buff), "Volume (%samerican gallon)", prefix);
        break;

    case 0x24:
        // E010 0100
        my_snprintf(buff, sizeof(buff), "Volume flow (0.001 american gallon/min)");
        break;
    case 0x25:
        // E010 0101
        my_snprintf(buff, sizeof(buff), "Volume flow (american gallon/min)");
        break;
    case 0x26:
        // E010 0110
        my_snprintf(buff, sizeof(buff), "Volume flow (american gallon/h)");
        break;
    case 0x27:
        // E010 0111, Reserved
        my_snprintf(buff, sizeof(buff), "Reserved (0x%.2x)", vib->vife[0]);
    ...
    case 0x28 + 1:
        ...
        if (n == 0)
           prefix = "0.1 ";
        my_snprintf(buff, sizeof(buff), "Power (%sMW)", prefix);
        break;
    case 0x2A:
    case 0x2A + 1:
    case 0x2C:
    ...
    case 0x30 + 1:
        ...
        if (n == 0)
           prefix = "0.1 ";
        my_snprintf(buff, sizeof(buff), "Power (%sGJ/h)", prefix);
        break;
    case 0x32:
    case 0x33:
    case 0x34:
    ...
    case 0x58 + 3:
        // E101 10nn
        n = 0x03 & vib->vife[0];
        my_snprintf(buff, sizeof(buff), "Flow Temperature (%s degree F)", mbus_unit_prefix(n -3));
        break;
    case 0x5C:
    case 0x5C + 1:
    case 0x5C + 2:
    case 0x5C + 3:
        // E101 11nn
        n = 0x03 & vib->vife[0];
        my_snprintf(buff, sizeof(buff), "Return Temperature (%s degree F)", mbus_unit_prefix(n -3));
        break;
    case 0x60:
    case 0x60 + 1:
    case 0x60 + 2:
    case 0x60 + 3:
        // E110 00nn
        n = 0x03 & vib->vife[0];
        my_snprintf(buff, sizeof(buff), "Temperature Difference (%s degree F)", mbus_unit_prefix(n -3));
        break;
    case 0x64:
    case 0x64 + 1:
    case 0x64 + 2:
    case 0x64 + 3:
        // E110 01nn
        n = 0x03 & vib->vife[0];
        my_snprintf(buff, sizeof(buff), "External Temperature (%s degree F)", mbus_unit_prefix(n -3));
        break;
    case 0x68:
    case 0x69:
    case 0x6A:
    ...
    case 0x70 + 3:
        // E111 00nn
        n = 0x03 & vib->vife[0];
        my_snprintf(buff, sizeof(buff), "Cold / Warm Temperature Limit (%s degree F)", mbus_unit_prefix(n -3));
        break;
    case 0x74:
    case 0x74 + 1:
    case 0x74 + 2:
    case 0x74 + 3:
        // E111 00nn
        n = 0x03 & vib->vife[0];
        my_snprintf(buff, sizeof(buff), "Cold / Warm Temperature Limit (%s degree C)", mbus_unit_prefix(n -3));
        break;
    case 0x78:
    case 0x78 + 1:
    case 0x78 + 2:
    ...
    case 0x78 + 7:
        // E111 1nnn
        n = 0x07 & vib->vife[0];
        my_snprintf(buff, sizeof(buff), "cumul. count max power (%s W)", mbus_unit_prefix(n - 3));
        break;
    default:
        my_snprintf(buff, sizeof(buff), "Unrecognized VIF 0xFB extension: 0x%.2x", vib->vife[0]);
        break;
    }
    return buff;
}
...
mbus_vib_unit_lookup_fd(mbus_value_information_block *vib)
{
    ...
    if ((masked_vife0 & 0x7C) == 0x00)
    {
        ...
        n = (masked_vife0 & 0x03);
        my_snprintf(buff, sizeof(buff), "Credit of %s of the nominal local legal currency units", mbus_unit_prefix(n - 3));
    }
    else if ((masked_vife0 & 0x7C) == 0x04)
    {
        // VIFE = E000 01nn Debit of 10nn-3 of the nominal local legal currency units
        n = (masked_vife0 & 0x03);
        my_snprintf(buff, sizeof(buff), "Debit of %s of the nominal local legal currency units", mbus_unit_prefix(n - 3));
    }
    else if (masked_vife0 == 0x08)
    {
        // E000 1000
        my_snprintf(buff, sizeof(buff), "Access Number (transmission count)");
    }
    else if (masked_vife0 == 0x09)
    {
        // E000 1001
        my_snprintf(buff, sizeof(buff), "Medium (as in fixed header)");
    }
    else if (masked_vife0 == 0x0A)
    {
        // E000 1010
        my_snprintf(buff, sizeof(buff), "Manufacturer (as in fixed header)");
    }
    else if (masked_vife0 == 0x0B)
    {
        // E000 1010
        my_snprintf(buff, sizeof(buff), "Parameter set identification");
    }
    else if (masked_vife0 == 0x0C)
    {
        // E000 1100
        my_snprintf(buff, sizeof(buff), "Model / Version");
    }
    else if (masked_vife0 == 0x0D)
    {
        // E000 1100
        my_snprintf(buff, sizeof(buff), "Hardware version");
    }
    else if (masked_vife0 == 0x0E)
    {
        // E000 1101
        my_snprintf(buff, sizeof(buff), "Firmware version");
    }
    else if (masked_vife0 == 0x0F)
    {
        // E000 1101
        my_snprintf(buff, sizeof(buff), "Software version");
    }
    else if (masked_vife0 == 0x10)
    {
        // VIFE = E001 0000 Customer location
        my_snprintf(buff, sizeof(buff), "Customer location");
    }
    else if (masked_vife0 == 0x11)
    {
        // VIFE = E001 0001 Customer
        my_snprintf(buff, sizeof(buff), "Customer");
    }
    else if (masked_vife0 == 0x12)
    {
        // VIFE = E001 0010	Access Code User
        my_snprintf(buff, sizeof(buff), "Access Code User");
    }
    else if (masked_vife0 == 0x13)
    {
        // VIFE = E001 0011	Access Code Operator
        my_snprintf(buff, sizeof(buff), "Access Code Operator");
    }
    else if (masked_vife0 == 0x14)
    {
        // VIFE = E001 0100	Access Code System Operator
        my_snprintf(buff, sizeof(buff), "Access Code System Operator");
    }
    else if (masked_vife0 == 0x15)
    {
        // VIFE = E001 0101	Access Code Developer
        my_snprintf(buff, sizeof(buff), "Access Code Developer");
    }
    else if (masked_vife0 == 0x16)
    {
        // VIFE = E001 0110 Password
        my_snprintf(buff, sizeof(buff), "Password");
    }
    else if (masked_vife0 == 0x17)
    {
        // VIFE = E001 0111 Error flags
        my_snprintf(buff, sizeof(buff), "Error flags");
    }
    else if (masked_vife0 == 0x18)
    {
        // VIFE = E001 1000	Error mask
        my_snprintf(buff, sizeof(buff), "Error mask");
    }
    ...
    else if (masked_vife0 == 0x20)
    {
        ...
        my_snprintf(buff, sizeof(buff), "First storage # for cyclic storage");
    }
    else if (masked_vife0 == 0x21)
    {
        // VIFE = E010 0001	Last storage # for cyclic storage
        my_snprintf(buff, sizeof(buff), "Last storage # for cyclic storage");
    }
    else if (masked_vife0 == 0x22)
    {
        // VIFE = E010 0010	Size of storage block
        my_snprintf(buff, sizeof(buff), "Size of storage block");
    }
    ...
    else if ((masked_vife0 & 0x7C) == 0x24)
    {
        ...
        n = (masked_vife0 & 0x03);
        my_snprintf(buff, sizeof(buff), "Storage interval %s", mbus_unit_duration_nn(n));
    }
    else if (masked_vife0 == 0x28)
    {
        // VIFE = E010 1000	Storage interval month(s)
        my_snprintf(buff, sizeof(buff), "Storage interval month(s)");
    }
    else if (masked_vife0 == 0x29)
    {
        // VIFE = E010 1001	Storage interval year(s)
        my_snprintf(buff, sizeof(buff), "Storage interval year(s)");
    }
    ...
    else if ((masked_vife0 & 0x7C) == 0x2C)
    {
        ...
        n = (masked_vife0 & 0x03);
        my_snprintf(buff, sizeof(buff), "Duration since last readout %s", mbus_unit_duration_nn(n));
    }
    else if (masked_vife0 == 0x30)
    {
        // VIFE = E011 0000	Start (date/time) of tariff
        my_snprintf(buff, sizeof(buff), "Start (date/time) of tariff");
    }
    else if ((masked_vife0 & 0x7C) == 0x30)
    {
        // VIFE = E011 00nn	Duration of tariff (nn=01 ..11: min to days)
        n = (masked_vife0 & 0x03);
        my_snprintf(buff, sizeof(buff), "Duration of tariff %s", mbus_unit_duration_nn(n));
    }
    else if ((masked_vife0 & 0x7C) == 0x34)
    {
        // VIFE = E011 01nn	Period of tariff [sec(s) to day(s)]
        n = (masked_vife0 & 0x03);
        my_snprintf(buff, sizeof(buff), "Period of tariff %s", mbus_unit_duration_nn(n));
    }
    else if (masked_vife0 == 0x38)
    {
        // VIFE = E011 1000	Period of tariff months(s)
        my_snprintf(buff, sizeof(buff), "Period of tariff months(s)");
    }
    else if (masked_vife0 == 0x39)
    {
        // VIFE = E011 1001	Period of tariff year(s)
        my_snprintf(buff, sizeof(buff), "Period of tariff year(s)");
    }
    else if (masked_vife0 == 0x3A)
    {
        // VIFE = E011 1010	dimensionless / no VIF
        my_snprintf(buff, sizeof(buff), "dimensionless / no VIF");
    }
    ...
    else if ((masked_vife0 & 0x70) == 0x40)
    {
        ...
        n = (masked_vife0 & 0x0F);
        my_snprintf(buff, sizeof(buff), "%s V", mbus_unit_prefix(n - 9));
    }
    else if ((masked_vife0 & 0x70) == 0x50)
    {
        // VIFE = E101 nnnn 10nnnn-12 A
        n = (masked_vife0 & 0x0F);
        my_snprintf(buff, sizeof(buff), "%s A", mbus_unit_prefix(n - 12));
    }
    else if (masked_vife0 == 0x60) {
        // VIFE = E110 0000	Reset counter
        my_snprintf(buff, sizeof(buff), "Reset counter");
    }
    else if (masked_vife0 == 0x61) {
        // VIFE = E110 0001	Cumulation counter
        my_snprintf(buff, sizeof(buff), "Cumulation counter");
    }
    else if (masked_vife0 == 0x62) {
        // VIFE = E110 0010	Control signal
        my_snprintf(buff, sizeof(buff), "Control signal");
    }
    else if (masked_vife0 == 0x63) {
        // VIFE = E110 0011	Day of week
        my_snprintf(buff, sizeof(buff), "Day of week");
    }
    else if (masked_vife0 == 0x64) {
        // VIFE = E110 0100	Week number
        my_snprintf(buff, sizeof(buff), "Week number");
    }
    else if (masked_vife0 == 0x65) {
        // VIFE = E110 0101	Time point of day change
        my_snprintf(buff, sizeof(buff), "Time point of day change");
    }
    else if (masked_vife0 == 0x66) {
        // VIFE = E110 0110	State of parameter activation
        my_snprintf(buff, sizeof(buff), "State of parameter activation");
    }
    else if (masked_vife0 == 0x67) {
        // VIFE = E110 0111	Special supplier information
        my_snprintf(buff, sizeof(buff), "Special supplier information");
    }
    else if ((masked_vife0 & 0x7C) == 0x68) {
        // VIFE = E110 10pp	Duration since last cumulation [hour(s)..years(s)]Ž
        n = (masked_vife0 & 0x03);
        my_snprintf(buff, sizeof(buff), "Duration since last cumulation %s", mbus_unit_duration_pp(n));
    }
    else if ((masked_vife0 & 0x7C) == 0x6C) {
        // VIFE = E110 11pp	Operating time battery [hour(s)..years(s)]Ž
        n = (masked_vife0 & 0x03);
        my_snprintf(buff, sizeof(buff), "Operating time battery %s", mbus_unit_duration_pp(n));
    }
    else if (masked_vife0 == 0x70) {
        // VIFE = E111 0000	Date and time of battery change
        my_snprintf(buff, sizeof(buff), "Date and time of battery change");
    }
    else if ((masked_vife0 & 0x70) == 0x70)
    {
        // VIFE = E111 nnn Reserved
        my_snprintf(buff, sizeof(buff), "Reserved VIF extension");
    }
    else
    {
        my_snprintf(buff, sizeof(buff), "Unrecognized VIF 0xFD extension: 0x%.2x", masked_vife0);
    }
...
mbus_vib_unit_lookup(mbus_value_information_block *vib)
{
    ...
    {
        // custom VIF
        my_snprintf(buff, sizeof(buff), "%s", vib->custom_vif);
        return buff;
    }
    else if (vib->vif == 0xFC && (vib->vife[0] & 0x78) == 0x70)
    {
        // custom VIF
        n = (vib->vife[0] & 0x07);
        my_snprintf(buff, sizeof(buff), "%s %s", mbus_unit_prefix(n-6), vib->custom_vif);
        return buff;
    }
    ...
    if (record)
    {
        ...
        switch (record->drh.dib.dif & MBUS_DATA_RECORD_DIF_MASK_DATA)
        {
            ...
            case 0x01: // 1 byte integer (8 bit)
                ...
                my_snprintf(buff, sizeof(buff), "%d", int_val);
            ...
            case 0x02: // 2 byte (16 bit)
                ...
                if (vif == 0x6C)
                {
                    ...
                    my_snprintf(buff, sizeof(buff), "%04d-%02d-%02d",
                                                 (time.tm_year + 1900),
                                                 (time.tm_mon + 1),
                                                  time.tm_mday);
                }
            ...
            case 0x04: // 4 byte (32 bit)
                    ...
                    ((record->drh.vib.vif == 0xFD) && (vife == 0x70)))
                {
                    ...
                    my_snprintf(buff, sizeof(buff), "%04d-%02d-%02dT%02d:%02d:%02d",
                                                 (time.tm_year + 1900),
                                                 (time.tm_mon + 1),
                                                  time.tm_mday,
                                                  time.tm_hour,
            ...
            case 0x05: // 4 Byte Real (32 bit)
                ...
                my_snprintf(buff, sizeof(buff), "%f", float_val);
            ...
            case 0x06: // 6 byte (48 bit)
                ...
                else  // 6 byte integer
                {
                    ...
                    my_snprintf(buff, sizeof(buff), "%lld", long_long_val);
                }
            ...
            case 0x09: // 2 digit BCD (8 bit)
                ...
                my_snprintf(buff, sizeof(buff), "%X", int_val);
            ...
            case 0x0E: // 12 digit BCD (48 bit)
                ...
                my_snprintf(buff, sizeof(buff), "%llX", long_long_val);
            ...
            default:
                ...
                my_snprintf(buff, sizeof(buff), "Unknown DIF (0x%.2x)", record->drh.dib.dif);
                break;
        }
...
mbus_data_record_unit(mbus_data_record *record)
{
    ...
    if (record)
    {
        my_snprintf(buff, sizeof(buff), "%s", mbus_vib_unit_lookup(&(record->drh.vib)));
...
mbus_data_record_value(mbus_data_record *record)
{
    ...
    if (record)
    {
        my_snprintf(buff, sizeof(buff), "%s", mbus_data_record_decode(record));
...
mbus_data_record_function(mbus_data_record *record)
{
    ...
    if (record)
    {
        ...
        {
            case 0x00:
                my_snprintf(buff, sizeof(buff), "Instantaneous value");
                break;

            case 0x10:
                my_snprintf(buff, sizeof(buff), "Maximum value");
                break;

            case 0x20:
                my_snprintf(buff, sizeof(buff), "Minimum value");
                break;

            case 0x30:
                my_snprintf(buff, sizeof(buff), "Value during error state");
                break;
...
mbus_data_fixed_function(int status)
{
    ...
    my_snprintf(buff, sizeof(buff), "%s",
...
mbus_parse(mbus_frame *frame, unsigned char *data, size_t data_size)
{
    ...
    if (frame && data && data_size > 0)
    {
        ...
        switch (data[0])
        {
            ...
            case MBUS_FRAME_SHORT_START:
                ...
                if (data_size != MBUS_FRAME_BASE_SIZE_SHORT)
                {
                    my_snprintf(error_str, sizeof(error_str), "Too much data in frame.");
            ...
            case MBUS_FRAME_LONG_START: // (also CONTROL)
                ...
                if (frame->length1 < 3)
                {
                    my_snprintf(error_str, sizeof(error_str), "Invalid M-Bus frame length.");
                ...
                return 0;
            default:
                my_snprintf(error_str, sizeof(error_str), "Invalid M-Bus frame start.");
    ...
    my_snprintf(error_str, sizeof(error_str), "Got null pointer to frame, data or zero data_size.");
...
mbus_data_fixed_parse(mbus_frame *frame, mbus_data_fixed *data)
{
    if (frame && data)
    {
        ...
        {
            my_snprintf(error_str, sizeof(error_str), "Invalid length for fixed data.");
            return -1;
        }
...
mbus_data_variable_parse(mbus_frame *frame, mbus_data_variable *data)
{
    ...
    if (frame && data)
    {
        ...
        {
            my_snprintf(error_str, sizeof(error_str), "Variable header too short.");
            return -1;
        }
        ...
        while (i < frame->data_size)
        {
                   ...
                   (frame->data[i] & MBUS_DIB_DIF_EXTENSION_BIT))
            {
                ...
                if (record->drh.dib.ndife >= MBUS_DATA_INFO_BLOCK_DIFE_SIZE)
                {
                    ...
                    my_snprintf(error_str, sizeof(error_str), "Too many DIFE.");
                    return -1;
                }
            ...
            {
                mbus_data_record_free(record);
                my_snprintf(error_str, sizeof(error_str), "Premature end of record at DIF.");
                return -1;
            }
            ...
            if ((record->drh.vib.vif & MBUS_DIB_VIF_WITHOUT_EXTENSION) == 0x7C)
            {
                ...
                {
                    mbus_data_record_free(record);
                    my_snprintf(error_str, sizeof(error_str), "Too long variable length VIF.");
                    return -1;
                }
                ...
                {
                    mbus_data_record_free(record);
                    my_snprintf(error_str, sizeof(error_str), "Premature end of record at variable length VIF.");
                    return -1;
                }
            ...
            if (record->drh.vib.vif & MBUS_DIB_VIF_EXTENSION_BIT)
            {
                       ...
                       (frame->data[i] & MBUS_DIB_VIF_EXTENSION_BIT))
                {
                    ...
                    {
                        mbus_data_record_free(record);
                        my_snprintf(error_str, sizeof(error_str), "Too many VIFE.");
                        return -1;
                    }
            ...
            {
                mbus_data_record_free(record);
                my_snprintf(error_str, sizeof(error_str), "Premature end of record at VIF.");
                return -1;
            }
            ...
            {
                mbus_data_record_free(record);
                my_snprintf(error_str, sizeof(error_str), "Premature end of record at data.");
                return -1;
            }
...
mbus_frame_data_parse(mbus_frame *frame, mbus_frame_data *data)
{
    ...
    if (data == NULL)
    {
        my_snprintf(error_str, sizeof(error_str), "Got null pointer to data.");
        return -1;
    }
    ...
    if (direction == MBUS_CONTROL_MASK_DIR_S2M)
    {
        ...
        else if (frame->control_information == MBUS_CONTROL_INFO_RESP_FIXED)
        {
            if (frame->data_size == 0)
            {
                my_snprintf(error_str, sizeof(error_str), "Got zero data_size.");
        ...
        {
            my_snprintf(error_str, sizeof(error_str), "Unknown control information 0x%.2x", frame->control_information);

            return -1;
        }
    }

    my_snprintf(error_str, sizeof(error_str), "Wrong direction in frame (master to slave)");
...
mbus_str_xml_encode(unsigned char *dst, const unsigned char *src, size_t max_len)
{
    ...
    while((len+6) < max_len)
    {
        ...
        else
        {
            ...
            {
                case '&':
                    len += my_snprintf(&dst[len], max_len - len, "&amp;");
                    break;
                case '<':
                    len += my_snprintf(&dst[len], max_len - len, "&lt;");
                    break;
...
mbus_data_variable_header_xml(mbus_data_variable_header *header)
{
    ...
    if (header)
    {
        len += my_snprintf(&buff[len], sizeof(buff) - len, "    <SlaveInformation>\n");

        len += my_snprintf(&buff[len], sizeof(buff) - len, "        <Id>%llX</Id>\n", mbus_data_bcd_decode_hex(header->id_bcd, 4));
        len += my_snprintf(&buff[len], sizeof(buff) - len, "        <Manufacturer>%s</Manufacturer>\n",
                mbus_decode_manufacturer(header->manufacturer[0], header->manufacturer[1]));
        len += my_snprintf(&buff[len], sizeof(buff) - len, "        <Version>%d</Version>\n", header->version);

        mbus_str_xml_encode(str_encoded, mbus_data_product_name(header), sizeof(str_encoded));

        len += my_snprintf(&buff[len], sizeof(buff) - len, "        <ProductName>%s</ProductName>\n", str_encoded);

        mbus_str_xml_encode(str_encoded, mbus_data_variable_medium_lookup(header->medium), sizeof(str_encoded));

        len += my_snprintf(&buff[len], sizeof(buff) - len, "        <Medium>%s</Medium>\n", str_encoded);
        len += my_snprintf(&buff[len], sizeof(buff) - len, "        <AccessNumber>%d</AccessNumber>\n", header->access_no);
        len += my_snprintf(&buff[len], sizeof(buff) - len, "        <Status>%.2X</Status>\n", header->status);
        len += my_snprintf(&buff[len], sizeof(buff) - len, "        <Signature>%.2X%.2X</Signature>\n", header->signature[1], header->signature[0]);
...
mbus_data_variable_record_xml(mbus_data_record *record, int record_cnt, int frame_cnt, mbus_data_variable_header *header)
{
    ...
    if (record)
    {
        if (frame_cnt >= 0)
        {
            len += my_snprintf(&buff[len], sizeof(buff) - len,
        ...
        else
        {
            ...
            {
                len += my_snprintf(&buff[len], sizeof(buff) - len, "        <Tariff>%ld</Tariff>\n",
                                tariff);
                len += my_snprintf(&buff[len], sizeof(buff) - len, "        <Device>%d</Device>\n",
        ...
        len += my_snprintf(&buff[len], sizeof(buff) - len, "        <Value>%s</Value>\n", str_encoded);
        ...
        len += my_snprintf(&buff[len], sizeof(buff) - len, "    </DataRecord>\n\n");
...
mbus_data_variable_xml(mbus_data_variable *data)
{
    ...
    if (data)
    {
        ...
        len += my_snprintf(&buff[len], buff_size - len, MBUS_XML_PROCESSING_INSTRUCTION);

        len += my_snprintf(&buff[len], buff_size - len, "<MBusData>\n\n");

        len += my_snprintf(&buff[len], buff_size - len, "%s",
...
mbus_data_fixed_xml(mbus_data_fixed *data)
{
    ...
    if (data)
    {
        ...
        len += my_snprintf(&buff[len], buff_size - len, "    <SlaveInformation>\n");
        len += my_snprintf(&buff[len], buff_size - len, "        <Id>%llX</Id>\n", mbus_data_bcd_decode_hex(data->id_bcd, 4));

        mbus_str_xml_encode(str_encoded, mbus_data_fixed_medium(data), sizeof(str_encoded));
        len += my_snprintf(&buff[len], buff_size - len, "        <Medium>%s</Medium>\n", str_encoded);

        len += my_snprintf(&buff[len], buff_size - len, "        <AccessNumber>%d</AccessNumber>\n", data->tx_cnt);
        len += my_snprintf(&buff[len], buff_size - len, "        <Status>%.2X</Status>\n", data->status);
        len += my_snprintf(&buff[len], buff_size - len, "    </SlaveInformation>\n\n");

        len += my_snprintf(&buff[len], buff_size - len, "    <DataRecord id=\"0\">\n");

        mbus_str_xml_encode(str_encoded, mbus_data_fixed_function(data->status), sizeof(str_encoded));
        len += my_snprintf(&buff[len], buff_size - len, "        <Function>%s</Function>\n", str_encoded);

        mbus_str_xml_encode(str_encoded, mbus_data_fixed_unit(data->cnt1_type), sizeof(str_encoded));
        len += my_snprintf(&buff[len], buff_size - len, "        <Unit>%s</Unit>\n", str_encoded);
        if ((data->status & MBUS_DATA_FIXED_STATUS_FORMAT_MASK) == MBUS_DATA_FIXED_STATUS_FORMAT_BCD)
        {
            len += my_snprintf(&buff[len], buff_size - len, "        <Value>%llX</Value>\n", mbus_data_bcd_decode_hex(data->cnt1_val, 4));
        }
        else
        {
            mbus_data_int_decode(data->cnt1_val, 4, &val);
            len += my_snprintf(&buff[len], buff_size - len, "        <Value>%d</Value>\n", val);
        }

        len += my_snprintf(&buff[len], buff_size - len, "    </DataRecord>\n\n");

        len += my_snprintf(&buff[len], buff_size - len, "    <DataRecord id=\"1\">\n");
...
mbus_data_error_xml(int error)
{
    ...
    len += my_snprintf(&buff[len], buff_size - len, "        <Error>%s</Error>\n", str_encoded);
...
mbus_frame_get_secondary_address(mbus_frame *frame)
{
    ...
    {
        my_snprintf(error_str, sizeof(error_str), "Non-variable data response (can't get secondary address from response).");
    ...
    my_snprintf(addr, sizeof(addr), "%08lX%02X%02X%02X%02X",
             id,
...
mbus_frame_select_secondary_pack(mbus_frame *frame, char *address)
{
    ...
    {
        my_snprintf(error_str, sizeof(error_str), "%s: frame or address arguments are NULL.", __PRETTY_FUNCTION__);
        return -1;
    }

    if (mbus_is_secondary_address(address) == 0)
    {
        my_snprintf(error_str, sizeof(error_str), "%s: address is invalid.", __PRETTY_FUNCTION__);
        return -1;
    }
