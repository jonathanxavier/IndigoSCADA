...
int64_t mbus_data_bcd_decode(unsigned char *bcd_data, size_t bcd_data_size);
int64_t mbus_data_bcd_decode_hex(unsigned char *bcd_data, size_t bcd_data_size);
...
int mbus_data_long_long_decode(unsigned char *int_data, size_t int_data_size, int64_t *value);
