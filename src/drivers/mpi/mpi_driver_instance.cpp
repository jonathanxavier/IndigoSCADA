...
void Mpi_driver_Instance::Start() 
{
	IT_IT("Mpi_driver_Instance::Start");
...
*Returns:none
*/
void Mpi_driver_Instance::Stop() // stop everything under this driver's control
{	
	IT_IT("Mpi_driver_Instance::Stop");
...
*Returns:none
*/
void Mpi_driver_Instance::QueryResponse(QObject *p, const QString &c, int id, QObject*caller) // handles database responses
{
	IT_IT("Mpi_driver_Instance::QueryResponse");
...
//						Values[k].fSpotValue = a.toInt(); 
		...
		case tUnitProperties:
		{
			if(GetConfigureDb()->GetNumberResults() > 0)
			{
				...
				//Start MPI client driver
				if(!Connect())
				{
					QSLogAlarm(Name,tr("Failed to start MPI client driver"));
				}
			}
		}
		break;
...
*/
//Realtime method
void Mpi_driver_Instance::driverEvent(DriverEvent *p)
{
	IT_IT("Mpi_driver_Instance::driverEvent");
...
//Realtime method
bool Mpi_driver_Instance::expect(unsigned int cmd)
{
	IT_IT("Mpi_driver_Instance::expect");
...
//Realtime method
void Mpi_driver_Instance::removeTransaction()
{
	IT_IT("Mpi_driver_Instance::removeTransaction");
...
void Mpi_driver_Instance::Tick()
{
	IT_IT("Mpi_driver_Instance::Tick");
...
//Realtime method
bool Mpi_driver_Instance::event(QEvent *e)
{
	IT_IT("Mpi_driver_Instance::event");
...
bool Mpi_driver_Instance::Connect() 
{	
	IT_IT("Mpi_driver_Instance::Connect");
	//return 0 on fail
	//return 1 on success

	if(pConnect) delete pConnect;
	
	pConnect = new Mpi_DriverThread(this); // create the connection
...
*Returns:none
*/
bool  Mpi_driver_Instance::Disconnect()        
{
	IT_IT("Mpi_driver_Instance::Disconnect");
...
*/
//Realtime method
bool  Mpi_driver_Instance::DoExec(SendRecePacket *t)
{
	IT_IT("Mpi_driver_Instance::DoExec");
...
*Returns:none
*/
void Mpi_driver_Instance::Command(const QString & name, BYTE cmd, LPVOID lpPa, DWORD pa_length, DWORD ipindex) // process a command for a named unit 
{
	IT_IT("Mpi_driver_Instance::Command");
...
/*
void Mpi_driver_Instance::EndProcess(int nIndex)
{	
