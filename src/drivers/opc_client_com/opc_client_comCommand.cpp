...
File: Opc_client_comCommand.cpp
Last generated: Mon May 22 17:14:04 2000
*********************************************************************/
#include "Opc_client_comCommand.h"
#include <qt.h>
#include "opc_client_com.h"
#define Inherited Opc_client_comCommandData
Opc_client_comCommand::Opc_client_comCommand
(
QWidget* parent,
const char* name,
...
{
	setCaption(tr("Opc_client_com Command"));
...
void Opc_client_comCommand::Help()
{
	//
	// invoke the help viewer for the Opc_client_com
	// 
	QSHelp("Opc_client_com_command");
}

void Opc_client_comCommand::OkClicked()
{
...
void Opc_client_comCommand::QueryResponse (QObject *p, const QString &c, int id, QObject*caller) // handles database responses
{
	if(p != this) return;
	switch(id)
	{
