...
#ifndef OPC_CLIENT_COM__INSTANCE
#define OPC_CLIENT_COM__INSTANCE
...
class OPC_CLIENT_COMDRV Opc_client_com_Instance : public DriverInstance 
{
	Q_OBJECT
	//
	//
...
//	QStringList SampleList; // list of sample points
	...
	public:
	Opc_client_com_DriverThread *pConnect;
	fifo_h fifo_control_direction;
	unsigned int msg_sent_in_control_direction;

	//
	Opc_client_com_Instance(Driver *parent, const QString &name) : 
	...
	{
		IT_IT("Opc_client_com_Instance::Opc_client_com_Instance");
