...
File: Opc_client_comCommandData.cpp
...
Opc_client_comCommandData::Opc_client_comCommandData(QWidget *parent, const char *name)
...
Opc_client_comCommandData::~Opc_client_comCommandData()
{
}
