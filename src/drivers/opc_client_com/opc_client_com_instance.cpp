...
void Opc_client_com_Instance::Start() 
{
	IT_IT("Opc_client_com_Instance::Start");
...
*Returns:none
*/
void Opc_client_com_Instance::Stop() // stop everything under this driver's control
{	
	IT_IT("Opc_client_com_Instance::Stop");
...
*Returns:none
*/
void Opc_client_com_Instance::QueryResponse(QObject *p, const QString &c, int id, QObject*caller) // handles database responses
{
	IT_IT("Opc_client_com_Instance::QueryResponse");
...
*/
//Realtime method
void Opc_client_com_Instance::driverEvent(DriverEvent *p)
{
	IT_IT("Opc_client_com_Instance::driverEvent");
...
//Realtime method
bool Opc_client_com_Instance::expect(unsigned int cmd)
{
	IT_IT("Opc_client_com_Instance::expect");
...
//Realtime method
void Opc_client_com_Instance::removeTransaction()
{
	IT_IT("Opc_client_com_Instance::removeTransaction");
...
*/
//Realtime timer
void Opc_client_com_Instance::Tick()
{
	IT_IT("Opc_client_com_Instance::Tick");
...
//Realtime method
bool Opc_client_com_Instance::event(QEvent *e)
{
	IT_IT("Opc_client_com_Instance::event");
...
bool Opc_client_com_Instance::Connect() 
{	
	IT_IT("Opc_client_com_Instance::Connect");
	//return 0 on fail
	//retunr 1 on success

	if(pConnect) delete pConnect;
	
	pConnect = new Opc_client_com_DriverThread(this); // create the connection
...
*Returns:none
*/
bool  Opc_client_com_Instance::Disconnect()        
{
	IT_IT("Opc_client_com_Instance::Disconnect");
...
*/
//Realtime method
bool  Opc_client_com_Instance::DoExec(SendRecePacket *t)
{
	IT_IT("Opc_client_com_Instance::DoExec");
...
*Returns:none
*/
void Opc_client_com_Instance::Command(const QString & name, BYTE cmd, LPVOID lpPa, DWORD pa_length, DWORD ipindex) // process a command for a named unit 
{
	IT_IT("Opc_client_com_Instance::Command");
