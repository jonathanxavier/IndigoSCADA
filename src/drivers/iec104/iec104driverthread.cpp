...
int Iec104DriverThread::pipe_put(char *buf, int len, char* pipe_name)
{ 
	int rc = 0;
...
void Iec104DriverThread::TerminateIEC() // parent requests the thread close
{
	IT_IT("Iec104DriverThread::TerminateIEC");
